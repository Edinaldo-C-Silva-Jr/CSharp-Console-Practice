...
namespace InputValidation
{
	...
	{
		private int cursorX = 0, cursorY = 0; // Cursor position values - Used in the method ClearPreviousLine()
		
		private string[] validStrings = new string[] {}; // Array that contains the values which are considered valid - Used in the method ValidateString()
		private char[] validChars = new char[] {}; // Array that contains the char values that are considered valid - Used in the method ValidateChar()
		private string inputToTest = "";
		private char charToTest = ' ';
		private double numberToTest = 0;
		private int integerToTest = 0;
		...
		private void ClearPreviousLine(int inputLength)
		{
		...
		public void SetValidStrings(string[] valid)
		{
		...
		public void SetValidChars(char[] valid)
		{
		...
		public double ValidateDoubleNotZero()
		{
			do
			{
		...
		public string ValidateInputSize (int minBound, int maxBound)
		{
		...
		public double ValidateNumericValue(double minValue, double maxValue)
		{	
		...
		public double ValidateNumberSign (bool positiveNumber)
		{
			do
			{
				numberToTest = ValidateDouble(); // First checks if the inputted value is a numeric value
